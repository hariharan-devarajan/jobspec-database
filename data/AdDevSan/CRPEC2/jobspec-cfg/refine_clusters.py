...
def main(h5ad_file_path, initial_cluster_json, output_directory):
    ...
    # THE FOLLOWING ARE NOT NEEDED ANYMORE BECAUSE INPUT IS H5AD THAT HAS UNDERGONE 1000 HVG & PCA

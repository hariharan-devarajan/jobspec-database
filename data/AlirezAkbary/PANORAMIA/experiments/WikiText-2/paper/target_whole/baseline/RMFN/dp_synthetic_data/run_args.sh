...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/paper/target_whole/baseline/RMFN/dp_synthetic_data/game_seed_$game_seed_num/" \
                    ...
                    --attack_baseline_training_args_which_test "test_10k" \

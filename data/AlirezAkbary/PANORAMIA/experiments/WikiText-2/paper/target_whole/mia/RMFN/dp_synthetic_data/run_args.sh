...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/paper/target_whole/mia/RMFN/dp_synthetic_data/$target_checkpoint/" \
                    --base_project_name "PANORAMIA-Wiki_Text_2-paper-target_whole-mia-RMFN-dp_synthetic_data-$target_checkpoint" \
                    ...
                    --audit_target_saving_dir "/home/aaa208/scratch/PANORAMIA/outputs/WikiText-2/audit_model/paper/target_whole/saved_model/epoch_100/epoch_100/$target_checkpoint/" \
                    ...
                    --attack_mia_run_name "RMFN" \
                    --attack_mia_training_args_seed $attack_seed_num \
                    --attack_mia_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/paper/target_whole/mia/RMFN/dp_synthetic_data/$target_checkpoint/" \
                    --attack_mia_training_args_which_test "test_10k" \
                    --attack_mia_training_args_max_steps 4000 \
                    ...
                    --attack_mia_training_args_phase1_max_steps 2000 \

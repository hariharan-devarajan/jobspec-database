#!/bin/bash
#SBATCH --job-name=HKNN_SS_5_job    # Job name
...
#SBATCH --output=logfiles/HKNN_SS_5_job_%j.log   # Standard output and error log
...
singularity exec docker://alleninst/mapping_on_hpc Rscript R_scripts/SS_HKNN_5.R > logfiles/HKNN_SS_5_logfile

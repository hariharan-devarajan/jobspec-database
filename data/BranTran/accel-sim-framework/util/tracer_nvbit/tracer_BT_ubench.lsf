...
config_file='config_feb2024_all_reduced.cfg'
while IFS= read -r benchmark; do
    ...
    jsrun -i -n1 -c1 -g1 -r1 --stdio_stdout ${replace_name}.out --stdio_stderr ${replace_name}.err $ACCELSIM_ROOT/../util/tracer_nvbit/run_hw_trace.py -B ${replace_name} -D 0 && rm ${replace_name}.err ${replace_name}.out;
done < "$config_file"
jswait all
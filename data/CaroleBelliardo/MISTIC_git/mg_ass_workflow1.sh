...
## 2.2.1 --- run hifiasm v. hifiasm_meta 0.2-r043
...
# 4.1.1 D-Genies
# 4.1.1 mashmap
#mashmap -r metafly/aubergine_I_oct__hifi_reads.contigs.fasta -q hifiasm3/aubergine_I_oct__hifi_reads.fasta
#/home/cbelliardo/Scripts_git/MashMap/scripts/generateDotPlot png small mashmap.out

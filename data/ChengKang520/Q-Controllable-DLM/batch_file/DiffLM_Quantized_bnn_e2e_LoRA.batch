...
#SBATCH --job-name=LoRA_Q_bnn_E2E
#SBATCH --err=LoRA_Q_bnn_E2E.err
#SBATCH --out=LoRA_Q_bnn_E2E.out
...
mpirun -np 1 python improved-diffusion/scripts/batch_decode.py /home/kangchen/Diffusion-LM-main/improved-diffusion/quantized_diffusion_models/diff_LoRA_e2e-tgt_bnn_0_0*/ -1.0 ema
python metrics_text.py --log_file './generation_outputs/diff_LoRA_e2e-tgt_bnn_0_0_block_rand16_transformer_lr0.0001_0.0_2000_sqrt_Lsimple_h128_s2_d0.1_sd102_xstart_e2e.ema_0.9999_200000.pt.samples_-1.0.txt' --tw_dir './datasets/wordlists/' --batch_size 8 --cap_per_example 100


####  Syntax Tree  // DONE
#mpirun -np 1 python train_run.py --task 'finetune' --quant_m ${quant_m} --weight_i_width ${weight_i_width} --weight_f_width ${weight_f_width} --experiment e2e-tgt-gen-tree --app "--init_emb /home/kangchen/Diffusion-LM-main/improved-diffusion/quantized_diffusion_models/diff_LoRA_e2e-tgt_bnn_0_0_block_rand16_transformer_lr0.0001_0.0_2000_sqrt_Lsimple_h128_s2_d0.1_sd102_xstart_e2e/ --n_embd 16 --learned_emb yes " --pretrained_model bert-base-uncased --epoch 6 --bsz 10

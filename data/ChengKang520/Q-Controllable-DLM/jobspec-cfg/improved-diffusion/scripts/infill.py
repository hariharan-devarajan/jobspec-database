...
sys.path.insert(0, '/home/kangchen/Diffusion-LM-main/transformers/examples/pytorch/language-modeling')
...
def main():
    ...
    model_p = th.load(args.model_path)
    ...
    if args.modality in ['synth', 'pos']:
        ...
        if args.eval_task_ == 'infill':
            ...
            if args.eval_task_ == 'control_attribute':
                if args.apply_lora is True:
                    model_path_load = '/home/kangchen/Diffusion-LM-main/classifier_models/e2e-back_LoRA_' + args.quant_m + str(
                        args.weight_i_width) + str(
                        args.weight_f_width) + '_e=6_b=10_m=gpt2_wikitext-103-raw-v1_101_wp_None/'
                else:
                    model_path_load = '/home/kangchen/Diffusion-LM-main/classifier_models/e2e-back_' + args.quant_m + str(
                        args.weight_i_width) + str(
                        args.weight_f_width) + '_e=6_b=10_m=gpt2_wikitext-103-raw-v1_101_wp_None/'
                model_control = Classifier_GPT2.from_pretrained(model_path_load).cuda()
            ...
            if args.eval_task_ == 'control_attribute_compose':
                ...
                if args.apply_lora is True:
                    model_path_load = '/home/kangchen/Diffusion-LM-main/classifier_models/e2e-back_LoRA_' + args.quant_m + str(
                        args.weight_i_width) + str(
                        args.weight_f_width) + '_e=6_b=10_m=bert-base-uncased_wikitext-103-raw-v1_101_wp_None/'
                else:
                    model_path_load = '/home/kangchen/Diffusion-LM-main/classifier_models/e2e-back_' + args.quant_m + str(
                        args.weight_i_width) + str(
                        args.weight_f_width) + '_e=6_b=10_m=bert-base-uncased_wikitext-103-raw-v1_101_wp_None/'
                model_control = Classifier_POS.from_pretrained(model_path_load).cuda()
                ...
                if args.apply_lora is True:
                    model_path_load = '/home/kangchen/Diffusion-LM-main/classifier_models/e2e-tgt-pos_LoRA_' + args.quant_m + str(
                        args.weight_i_width) + str(
                        args.weight_f_width) + '_e=6_b=10_m=bert-base-uncased_wikitext-103-raw-v1_101_wp_None/'
                else:
                    model_path_load = '/home/kangchen/Diffusion-LM-main/classifier_models/e2e-tgt-pos_' + args.quant_m + str(
                        args.weight_i_width) + str(
                        args.weight_f_width) + '_e=6_b=10_m=bert-base-uncased_wikitext-103-raw-v1_101_wp_None/'
                model_control = Classifier_POS.from_pretrained(model_path_load).cuda()
                ...
                if args.modality == 'e2e-tgt':
                    if args.apply_lora is True:
                        model_path_load = '/home/kangchen/Diffusion-LM-main/classifier_models/e2e-tgt-tree_LoRA_' + args.quant_m + str(
                            args.weight_i_width) + str(
                            args.weight_f_width) + '_e=6_b=10_m=bert-base-uncased_wikitext-103-raw-v1_101_wp_None/'
                    else:
                        model_path_load = '/home/kangchen/Diffusion-LM-main/classifier_models/e2e-tgt-tree_' + args.quant_m + str(
                            args.weight_i_width) + str(
                            args.weight_f_width) + '_e=6_b=10_m=bert-base-uncased_wikitext-103-raw-v1_101_wp_None/'
                elif args.modality == 'roc':
                    if args.apply_lora is True:
                        model_path_load = '/home/kangchen/Diffusion-LM-main/classifier_models/roc_LoRA_' + args.quant_m + str(
                            args.weight_i_width) + str(
                            args.weight_f_width) + '_e=6_b=10_m=bert-base-uncased_wikitext-103-raw-v1_101_wp_None/'
                    else:
                        model_path_load = '/home/kangchen/Diffusion-LM-main/classifier_models/roc_' + args.quant_m + str(
                            args.weight_i_width) + str(
                            args.weight_f_width) + '_e=6_b=10_m=bert-base-uncased_wikitext-103-raw-v1_101_wp_None/'

                model_control = Classifier_Tree.from_pretrained(model_path_load).cuda()
                ...
                ###############
                control_label_lst = []
                with open('datasets/control_target/target_tree.json',
                          'r') as controlf:
                    for line in controlf:
                        control_label_lst.append(json.loads(line))
            ...
            elif args.eval_task_ == 'control_spans':

                if args.apply_lora is True:
                    model_path_load = '/home/kangchen/Diffusion-LM-main/classifier_models/e2e-tgt-spans_LoRA_' + args.quant_m + str(
                        args.weight_i_width) + str(
                        args.weight_f_width) + '_e=6_b=10_m=bert-base-uncased_wikitext-103-raw-v1_101_wp_None/'
                else:
                    model_path_load = '/home/kangchen/Diffusion-LM-main/classifier_models/e2e-tgt-spans_' + args.quant_m + str(
                        args.weight_i_width) + str(
                        args.weight_f_width) + '_e=6_b=10_m=bert-base-uncased_wikitext-103-raw-v1_101_wp_None/'
                model_control = Classifier_Tree.from_pretrained(model_path_load, local_files_only=True).cuda()  #  , config=config

                # model_control = Classifier_Tree.from_pretrained(
                #     '/home/kangchen/Diffusion-LM-main/classifier_models/e2e-tgt-tree_' + args.quant_m + str(args.weight_i_width) + str(args.weight_f_width) + '_e=6_b=10_m=bert-base-uncased_wikitext-103-raw-v1_101_wp_None/').cuda()
                ...
                ###############
                control_label_lst = []
                with open('datasets/control_target/target_spans.json',
                          'r') as controlf:
                    for line in controlf:
                        control_label_lst.append(json.loads(line))
                # print(control_label_lst[:1])
    ...
    if args.verbose == 'pipe':
        ...
        out_path_pipe = os.path.join('/home/kangchen/Diffusion-LM-main/', args.out_dir, f"{model_base_name}.infill_{args.eval_task_}_{args.notes}.json")
...
def create_argparser():
    defaults = dict(
        ...
        batch_size=1,
        model_path="",
        out_dir="improved-diffusion/out_gen",

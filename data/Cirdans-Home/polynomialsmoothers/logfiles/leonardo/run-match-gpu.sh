...
mpirun -np ${psize} ./anisopsblascuda >> match/${degiter}/log_cheby4_match_l1jac_${idim}_task_${psize}_thr_1.txt 2>&1  <<EOF
...
mpirun -np ${psize} ./anisopsblascuda >> match/${degiter}/log_optcheby4_match_l1jac_${idim}_task_${psize}_thr_1.txt 2>&1  <<EOF
%%%%%%%%%%%  General  arguments % Lines starting with % are ignored.
HLG                     ! matrix storage format
${idim}                 ! Discretization grid size
${theta}                ! Theta Coefficient (Degree)
...
mpirun -np ${psize} ./anisopsblascuda >> match/${degiter}/log_optcheby1_match_l1jac_${idim}_task_${psize}_thr_1.txt 2>&1  <<EOF
%%%%%%%%%%%  General  arguments % Lines starting with % are ignored.
HLG                     ! matrix storage format
${idim}                 ! Discretization grid size
${theta}                ! Theta Coefficient (Degree)
...
mpirun -np ${psize} ./anisopsblascuda >> match/${degiter}/log_l1jacobi_match_l1jac_${idim}_task_${psize}_thr_1.txt 2>&1  <<EOF
%%%%%%%%%%%  General  arguments % Lines starting with % are ignored.
HLG                     ! matrix storage format
${idim}                 ! Discretization grid size
${theta}                ! Theta Coefficient (Degree)

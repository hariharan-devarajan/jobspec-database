...
srun -n ${psize} ./anisopsblascuda >> soc1/${degiter}/log_cheby4_svbm_l1jac_${idim}_task_${psize}_thr_1.txt 2>&1  <<EOF
...
srun -n ${psize} ./anisopsblascuda >> soc1/${degiter}/log_optcheby4_svbm_l1jac_${idim}_task_${psize}_thr_1.txt 2>&1  <<EOF
%%%%%%%%%%%  General  arguments % Lines starting with % are ignored.
HLG                     ! matrix storage format
${idim}                 ! Discretization grid size
${theta}                ! Theta Coefficient (Degree)
...
srun -n ${psize} ./anisopsblascuda >> soc1/${degiter}/log_optcheby1_svbm_l1jac_${idim}_task_${psize}_thr_1.txt 2>&1  <<EOF
%%%%%%%%%%%  General  arguments % Lines starting with % are ignored.
HLG                     ! matrix storage format
${idim}                 ! Discretization grid size
${theta}                ! Theta Coefficient (Degree)
...
mpirun -np ${psize} ./anisopsblascuda >> soc1/${degiter}/log_l1jac_svbm_l1jac_${idim}_task_${psize}_thr_1.txt 2>&1  <<EOF
%%%%%%%%%%%  General  arguments % Lines starting with % are ignored.
HLG                     ! matrix storage format
${idim}                 ! Discretization grid size
${theta}                ! Theta Coefficient (Degree)

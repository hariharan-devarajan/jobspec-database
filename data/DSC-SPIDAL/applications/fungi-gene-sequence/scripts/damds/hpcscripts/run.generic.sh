...
#TimingFile=$pat/$pat.$xmx.$memmultype.$4.$3.comm.$commpat.timing.txt
#SummaryFile=$pat/$pat.$xmx.$memmultype.$4.$3.comm.$commpat.summary.txt
#PointsFile=$pat/$pat.$xmx.$memmultype.$4.$3.comm.$commpat.points.txt
MDS_OPS=""

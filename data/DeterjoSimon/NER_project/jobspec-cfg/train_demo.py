...
def main():
    ...
    if not opt.use_sampled_data:
        ...
        opt.train = f'/work3/s174450/data/pico-episode-data/{opt.mode}/pico_{opt.N}_{opt.K}_train.jsonl'
        opt.test = f'/work3/s174450/data/pico-episode-data/{opt.mode}/pico_{opt.N}_{opt.K}_test.jsonl'
        opt.dev = f'/work3/s174450/data/pico-episode-data/{opt.mode}/pico_{opt.N}_{opt.K}_dev.jsonl'
        if not (os.path.exists(opt.train) and os.path.exists(opt.dev) and os.path.exists(opt.test)):

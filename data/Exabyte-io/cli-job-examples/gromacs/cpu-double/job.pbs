...
# load module
module add gromacs/2021.5-g-11.2.0-ompi-4.1.1-openblas-0.3.18-md
...
# run the calculation
mpirun -np $PBS_NP gmx_mpi mdrun -resethway -noconfout -nsteps 4000 -v -pin on -nb cpu > LOG_FILE 2>&1

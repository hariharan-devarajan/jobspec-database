...
#SBATCH --job-name=C90_M3_P30_G50     #Set the job name to "JobExample1"
#SBATCH --time=1:00:00            #Set the wall clock limit to 1hr and 30min
#SBATCH --ntasks=30                #Request 400 task
#SBATCH --ntasks-per-node=15        #Request 10 task/core per node

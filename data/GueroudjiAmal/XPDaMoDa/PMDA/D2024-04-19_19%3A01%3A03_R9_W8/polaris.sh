...
mpiexec  -n 1 --ppn 1  -d ${NDEPTH} --hostfile ClientNode  --exclusive  --cpu-bind depth  `which python` PMDA.py --mode=distributed --scheduler-file=$SCHEFILE  1>> producer.o 2>> producer.e &
client_pid=$!

...
while [ ${NOW} -le ${LASTDAY} ]; do
   ...
   if [ ${exp} == 'prod' ]; then
      ...
      comdir=/lfs/h2/emc/physics/noscrub/${USER}/com/aqm/prod/cs.${NOW}
   elif [ ${exp} == 'ncopara' ]; then
      comdir=/lfs/h1/ops/para/com/aqm/v6.1/cs.${NOW}
      comdir2=${comdir}
   elif [ ${exp} == 'para6c' ] || [ ${exp} == 'para6d' ] || [ ${exp} == 'para6e' ] || [ ${exp} == 'arlv6' ]; then
      comdir2=/lfs/h2/emc/physics/noscrub/${USER}/com/aqm/${exp}/cs.${NOW}
   ...
   for cych in "${cyc_opt[@]}"; do
      ...
      fig_dir=/lfs/h2/emc/stmp/${USER}/daily_plot_${mfileid}_max/aqm_${plotexp}_pm
      ...
      do
        case ${i} in
           max_1hr_pm25)  cp ${comdir}/aqm.${cychr}.max_1hr_${mfileid}.${grid227}.grib2  ${tmpdir};;
           ave_24hr_pm25) cp ${comdir}/aqm.${cychr}.ave_24hr_${mfileid}.${grid227}.grib2 ${tmpdir};;
           sp_pm)         cp ${comdir}/aqm.${cychr}.aconc_sfc.ncf                  ${tmpdir};;
           col_pm)        cp ${comdir}/aqm.${cychr}.pm25_column.ncf                ${tmpdir};;
           pm25)          cp ${comdir}/aqm.${cychr}.${mfileid}.f*.${grid148}.grib2      ${tmpdir};;
         esac
      done
      cd ${tmpdir}
...
#
         if [ ${typ[${ptyp}]} = 'max_1hr_pm25' ] || [ ${typ[${ptyp}]} = 'ave_24hr_pm25' ]; then 
            if [ ${typ[${ptyp}]} = 'max_1hr_pm25' ]; then 
               if [ "${cych}" == "06" ]; then
                  cat >  aqm.ctl <<EOF
dset ${tmpdir}/aqm.${cychr}.max_1hr_${mfileid}.${grid227}.grib2
index ${tmpdir}/aqm.${cychr}.max_1hr_${mfileid}.${grid227}.grib2.idx
undef 9.999E+20
title aqm.${cychr}.max_1hr_${mfileid}.${grid227}.grib2
* produced by alt_g2ctl v1.0.5, use alt_gmp to make idx file
* command line options: aqm.${cychr}.max_1hr_${mfileid}.${grid227}.grib2 -0t -short
...
EOF
               ...
               if [ "${cych}" == "06" ]; then
                  cat >  aqm.ctl <<EOF
dset ${tmpdir}/aqm.${cychr}.ave_24hr_${mfileid}.${grid227}.grib2
index ${tmpdir}/aqm.${cychr}.ave_24hr_${mfileid}.${grid227}.grib2.idx
undef 9.999E+20
title aqm.${cychr}.ave_24hr_${mfileid}.${grid227}.grib2
* produced by alt_g2ctl v1.0.5, use alt_gmp to make idx file
* command line options: aqm.${cychr}.ave_24hr_${mfileid}.${grid227}.grib2 -0t -short
* alt_gmp options: update=0
* alt_gmp options: nthreads=1
* alt_gmp options: big=0
* wgrib2 inventory flags: -npts -set_ext_name 1 -T -ext_name -ftime -lev
...
'set rgb 98   0 180   0'
'set rgb 97   0 231   0'
'set rgb 96  77 231  77'
'set rgb 95 255 255 127'
'set rgb 94 255 223   0'
'set rgb 93 255 165   0'
'set rgb 92 255  98  98'
'set rgb 91 255   0   0'
'set rgb 90 204   0   0'
'set rgb 89 179   0   0'
'set rgb 88 156 130 207'
'set rgb 87 132  99 195'
'set rgb 86 110  71 185'
'set rgb 85  76  49 128'
'set rgb 84 120 120 120'
...
'${gs_dir}/draw.aqm.pm25.3d.max.gs ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${typ[${ptyp}]} ${range1} ${range2} ${range3} conus'
'set lat ${lat0[${ieast}]} ${lat1[${ieast}]}'
'set lon ${lon0[${ieast}]} ${lon1[${ieast}]}'
'${gs_dir}/draw.aqm.pm25.3d.max.gs ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${typ[${ptyp}]} ${range1} ${range2} ${range3} east'
'set lat ${lat0[${iwest}]} ${lat1[${iwest}]}'
'set lon ${lon0[${iwest}]} ${lon1[${iwest}]}'
'${gs_dir}/draw.aqm.pm25.3d.max.gs ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${typ[${ptyp}]} ${range1} ${range2} ${range3} west'
'set lat ${lat0[${ine10}]} ${lat1[${ine10}]}'
'set lon ${lon0[${ine10}]} ${lon1[${ine10}]}'
'${gs_dir}/draw.aqm.pm25.3d.max.gs ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${typ[${ptyp}]} ${range1} ${range2} ${range3} ne'
'set lat ${lat0[${inw10}]} ${lat1[${inw10}]}'
'set lon ${lon0[${inw10}]} ${lon1[${inw10}]}'
'${gs_dir}/draw.aqm.pm25.3d.max.gs ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${typ[${ptyp}]} ${range1} ${range2} ${range3} nw'
'set lat ${lat0[${ise10}]} ${lat1[${ise10}]}'
'set lon ${lon0[${ise10}]} ${lon1[${ise10}]}'
'${gs_dir}/draw.aqm.pm25.3d.max.gs ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${typ[${ptyp}]} ${range1} ${range2} ${range3} se'
'set lat ${lat0[${iswse}]} ${lat1[${iswse}]}'
'set lon ${lon0[${iswse}]} ${lon1[${iswse}]}'
'${gs_dir}/draw.aqm.pm25.3d.max.gs ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${typ[${ptyp}]} ${range1} ${range2} ${range3} sw'
'quit'
EOF
...
'set lat ${lat0[${iconus}]} ${lat1[${iconus}]}'
'set lon ${lon0[${iconus}]} ${lon1[${iconus}]}'
'${gs_dir}/draw2.aqm.${typ[${ptyp}]}.gs2 ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${i} ${date}/${numj}00V${fcsti} conus'
'set lat ${lat0[${ieast}]} ${lat1[${ieast}]}'
'set lon ${lon0[${ieast}]} ${lon1[${ieast}]}'
'${gs_dir}/draw2.aqm.${typ[${ptyp}]}.gs2 ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${i} ${date}/${numj}00V${fcsti} east'
'set lat ${lat0[${iwest}]} ${lat1[${iwest}]}'
'set lon ${lon0[${iwest}]} ${lon1[${iwest}]}'
'${gs_dir}/draw2.aqm.${typ[${ptyp}]}.gs2 ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${i} ${date}/${numj}00V${fcsti} west'
'set lat ${lat0[${ine10}]} ${lat1[${ine10}]}'
'set lon ${lon0[${ine10}]} ${lon1[${ine10}]}'
'${gs_dir}/draw2.aqm.${typ[${ptyp}]}.gs2 ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${i} ${date}/${numj}00V${fcsti} ne'
'set lat ${lat0[${inw10}]} ${lat1[${inw10}]}'
'set lon ${lon0[${inw10}]} ${lon1[${inw10}]}'
'${gs_dir}/draw2.aqm.${typ[${ptyp}]}.gs2 ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${i} ${date}/${numj}00V${fcsti} nw'
'set lat ${lat0[${ise10}]} ${lat1[${ise10}]}'
'set lon ${lon0[${ise10}]} ${lon1[${ise10}]}'
'${gs_dir}/draw2.aqm.${typ[${ptyp}]}.gs2 ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${i} ${date}/${numj}00V${fcsti} se'
'set lat ${lat0[${iswse}]} ${lat1[${iswse}]}'
'set lon ${lon0[${iswse}]} ${lon1[${iswse}]}'
'${gs_dir}/draw2.aqm.${typ[${ptyp}]}.gs2 ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${i} ${date}/${numj}00V${fcsti} sw'
'quit'
EOF
                  grads -blc "run aqm.plots"
...
* produced by alt_g2ctl v1.0.5, use alt_gmp to make idx file
* command line options: aqm.${cychr}.${hfileid}.f${i}.${grid148}.grib2
* alt_gmp options: update=0
* alt_gmp options: nthreads=1
* alt_gmp options: big=0
...
'set lat ${lat0[${iconus}]} ${lat1[${iconus}]}'
'set lon ${lon0[${iconus}]} ${lon1[${iconus}]}'
'${gs_dir}/draw.aqm.pm25.gs ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${i} ${date}/${numj}00V${fcsti} conus'
'set lat ${lat0[${ieast}]} ${lat1[${ieast}]}'
'set lon ${lon0[${ieast}]} ${lon1[${ieast}]}'
'${gs_dir}/draw.aqm.pm25.gs ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${i} ${date}/${numj}00V${fcsti} east'
'set lat ${lat0[${iwest}]} ${lat1[${iwest}]}'
'set lon ${lon0[${iwest}]} ${lon1[${iwest}]}'
'${gs_dir}/draw.aqm.pm25.gs ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${i} ${date}/${numj}00V${fcsti} west'
'set lat ${lat0[${ine10}]} ${lat1[${ine10}]}'
'set lon ${lon0[${ine10}]} ${lon1[${ine10}]}'
'${gs_dir}/draw.aqm.pm25.gs ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${i} ${date}/${numj}00V${fcsti} ne'
'set lat ${lat0[${inw10}]} ${lat1[${inw10}]}'
'set lon ${lon0[${inw10}]} ${lon1[${inw10}]}'
'${gs_dir}/draw.aqm.pm25.gs ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${i} ${date}/${numj}00V${fcsti} nw'
'set lat ${lat0[${ise10}]} ${lat1[${ise10}]}'
'set lon ${lon0[${ise10}]} ${lon1[${ise10}]}'
'${gs_dir}/draw.aqm.pm25.gs ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${i} ${date}/${numj}00V${fcsti} se'
'set lat ${lat0[${iswse}]} ${lat1[${iswse}]}'
'set lon ${lon0[${iswse}]} ${lon1[${iswse}]}'
'${gs_dir}/draw.aqm.pm25.gs ${gs_dir} ${outdir} ${plotexp} ${plotcapexp} ${NOW} ${cychr} ${i} ${date}/${numj}00V${fcsti} sw'
'quit'
EOF
                  grads -blc "run aqm.plots"
               fi

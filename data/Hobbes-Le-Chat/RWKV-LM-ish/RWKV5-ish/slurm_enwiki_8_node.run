...
time srun --cpu_bind=v python3 train.py --wandb 'enwiki-${SLURM_JOB_NUM_NODES}N' --load_model "" --proj_dir $projout --my_exit_tokens 563743767  --magic_prime 68813 --my_pile_stage 2 --data_file "../../data_enwiki_text_document" --data_type "binidx" --vocab_size 65525 --ctx_len 8192 --epoch_steps 100 --epoch_count 10 --epoch_begin 0 --epoch_save 5 --micro_bsz 10 --n_layer 48 --n_embd 2048 --pre_ffn 0 --head_qk 0 --lr_init 2e-4 --lr_final 2e-5 --warmup_steps 0 --beta1 0.9 --beta2 0.999 --adam_eps 1e-8 --accelerator gpu --devices 8 --num_nodes $SLURM_JOB_NUM_NODES  --precision bf16 --strategy deepspeed_stage_2 --grad_cp 1

#time srun --cpu_bind=v python3 train.py --wandb "Enwiki-${SLURM_JOB_NUM_NODES}N" --load_model "" --proj_dir $projout --data_file "/data_enwiki_text_document" --data_type "binidx" --vocab_size 65536 --ctx_len 4096 --epoch_steps 100 --epoch_count 10 --epoch_begin 0 --epoch_save 5 --micro_bsz 1 --n_layer 48 --n_embd 2048 --pre_ffn 0 --head_qk 0 --lr_init 2e-4 --lr_final 2e-5 --warmup_steps 0 --beta1 0.9 --beta2 0.999 --adam_eps 1e-8 --accelerator gpu --devices 8 --num_nodes $SLURM_JOB_NUM_NODES --precision bf16 --strategy deepspeed_stage_2 --grad_cp 1




#time srun --cpu_bind=v python3 train.py --wandb "Enwiki-${SLURM_JOB_NUM_NODES}N" --load_model "" --proj_dir $projout --my_exit_tokens 59976837218 --magic_prime 14642759 --my_pile_stage 2 --data_file "/lustre/orion/stf006/world-shared/aihct/CRUSHER_TEST/datapath/data_enwiki_text_document" --data_type "binidx" --vocab_size 65536 --ctx_len 4096 --epoch_steps 100 --epoch_count 10 --epoch_begin 0 --epoch_save 5 --micro_bsz 1 --n_layer 48 --n_embd 2048 --pre_ffn 0 --head_qk 0 --lr_init 2e-4 --lr_final 2e-5 --warmup_steps 0 --beta1 0.9 --beta2 0.999 --adam_eps 1e-8 --accelerator gpu --devices 8 --num_nodes $SLURM_JOB_NUM_NODES --precision bf16 --strategy deepspeed_stage_2 --grad_cp 1

#--load_model "" --proj_dir $projout --data_file "/data/rwkv5-world-slimpajama-1_text_document_1" --data_type "binidx" --vocab_size 65536 --ctx_len 4096 --epoch_steps 100 --epoch_count 10 --epoch_begin 0 --epoch_save 5 --micro_bsz 8 --n_layer 32 --n_embd 4096 --pre_ffn 0 --head_qk 0 --lr_init 5e-5 --lr_final 1e-5 --warmup_steps 0 --beta1 0.9 --beta2 0.999 --adam_eps 1e-8 --accelerator gpu --devices 8 --num_nodes $SLURM_JOB_NUM_NODES --precision bf16 --strategy deepspeed_stage_3 --grad_cp 1

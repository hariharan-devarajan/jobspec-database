...
#SBATCH -t 0-05:00
#SBATCH --array 592-1183%30
#SBATCH --mem 16G
#SBATCH --chdir=/home/jrick6/repos/data
#SBATCH --job-name=gen_image_var
#SBATCH --output=/home/jrick6/repos/data/logs/imagenette/set1/shard1/%x.%A.%a.out
...
/home/jrick6/.conda/envs/simclr/bin/python generate_image_variations.py \
    ...
    -o "/home/jrick6/tensorflow_datasets/imagenette_id_variations1/full-size-v2/1.0.0/dir_imagenette-train.tfrecord-00001-of-00016/imagenette-train.tfrecord-00001-of-00016" \

...
# nnUNetv2_predict -f all -i /projects/0/nwo2021061/uls23/nnUNet_raw/Dataset500_DeepLesion3D/imagesTs -o /home/ljulius/data/output/baseline/Dataset500_DeepLesion3D -d 400 -c nnUNetTrainer_ULS_50_HalfLR

# export dataset_id=502
# nnUNetv2_predict -f all -i /projects/0/nwo2021061/uls23/nnUNet_raw/Dataset502_RadboudumcPancreas/imagesTs -o /home/ljulius/data/output/baseline/Dataset502_RadboudumcPancreas -d 400 -c nnUNetTrainer_ULS_50_HalfLR

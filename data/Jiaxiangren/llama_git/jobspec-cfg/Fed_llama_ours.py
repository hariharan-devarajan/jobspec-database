from flearn.experiments.llama_ours import *
...
def get_parser():
    ...
    parser.add_argument("--personalization", required=False, default=1)
...
def main():
    ...
    training_args.personalization = int(hyper_params.personalization)

# Snakemake pipeline for the analysis of ATAC-seq PE or SE
...
MACS2               =     expand(RESULT_DIR + "macs2/{sample}_peaks.narrowPeak", sample = SAMPLES)  

...
# Outputs ----------------------------------
#SBATCH --output=log/%x/COC/%x-COC_%A-%a.out   
#SBATCH --error=log/%x/COC/%x-COC_%A-%a.err   
# ------------------------------------------
...
# sbatch --array=2-$(( $( wc -l ../dset-COC/participants.tsv | cut -f1 -d' ' ) - 1 ))%10 denoising_job.sbatch

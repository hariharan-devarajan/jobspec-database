...
#PBS -N lemmatizer_competition_256
#PBS -l select=1:mem=10gb:scratch_local=5gb:ncpus=5:ngpus=1:cuda_version=11.2:gpu_cap=cuda75
#PBS -q gpu
...
REPOSITORY="10"
PROGRAM_PATH=""
CMD="python3 lemmatizer_competition.py"

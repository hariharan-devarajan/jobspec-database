...
#PBS -N reading_comprehension
#PBS -l select=1:mem=20gb:scratch_local=15gb:ncpus=10:ngpus=1:cuda_version=11.2:gpu_cap=cuda75
#PBS -q gpu
...
REPOSITORY="11"
PROGRAM_PATH=""
CMD="python3 reading_comprehension.py"
...
#echo "pip3 install transformers" > my_new_script.sh

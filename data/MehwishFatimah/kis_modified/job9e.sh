...
conda activate kis
python /hits/basement/nlp/fatimamh/codes/keep_it_simple/run_keep_it_simple.py -d /hits/basement/nlp/fatimamh/outputs/hipo/exp09/wiki_mono_test-rand_20-cos-order-add_f=0.0_b=1.0_s=1.0
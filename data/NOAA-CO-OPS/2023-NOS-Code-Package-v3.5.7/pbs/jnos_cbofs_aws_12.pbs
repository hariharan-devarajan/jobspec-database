...
#PBS  -A NOSOFS-DEV
#PBS  -q dev_transfer
#PBS  -o /lfs/h1/nos/ptmp/aijun.zhang/rpt/v3.6.0/cbofs_aws_12.out
#PBS  -e /lfs/h1/nos/ptmp/aijun.zhang/rpt/v3.6.0/cbofs_aws_12.err
...
WORKDIR=/lfs/h1/nos/ptmp/$LOGNAME/work/${nosofs_ver}/cbofs
if [ ! -r $WORKDIR ]; then
...
#s=${PBS_JOBID}
#mv ${RPTDIR}/cbofs_aws_12.out ${RPTDIR}/cbofs_aws_12.out."${s%%.*}"
#mv ${RPTDIR}/cbofs_aws_12.err ${RPTDIR}/cbofs_aws_12.err."${s%%.*}"
#######################################################################

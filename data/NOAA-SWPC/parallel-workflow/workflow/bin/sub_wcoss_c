...
echo ". $MODULESHOME/init/sh"				        >> $cfile
echo "module load PrgEnv-intel intel/15.0.3.187 cray-mpich"     >> $cfile
echo "module load prod_envir prod_util grib_util"		>> $cfile
...
echo "$exec"                                                    >> $cfile
echo "export OMP_NUM_THREADS=$nthreads"                         >> $cfile

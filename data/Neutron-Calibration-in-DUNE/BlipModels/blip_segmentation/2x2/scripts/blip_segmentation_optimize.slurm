...
#SBATCH -J blip_segmentation_test      # job name, '--job-name', '-J'
...
#SBATCH --dependency=afterok:<optimize_blip_segmentation_prep_id>      # don't run until prep job is finished
#SBATCH --array=0-9
...
# use that hyper_parameter_file as input to the optimize_blip_segmentation.sh script

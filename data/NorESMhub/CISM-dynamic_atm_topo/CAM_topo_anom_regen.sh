...
echo "Reference CISM file is $ISM_Topo_File_ref"
echo "Modelled CISM file is $ISM_Topo_File_mod0"
...
# Calculate anomalies
ncwa -O -a time -v thk,topg $ISM_Topo_File mod1_topography_file.nc
ncwa -O -a time -v thk,topg $ISM_Topo_File_ref ref_topography_file.nc
ncwa -O -a time -v thk,topg $ISM_Topo_File_mod0 mod0_topography_file.nc
ncdiff -O mod1_topography_file.nc mod0_topography_file.nc anom_topography_file.nc
ncrename -v thk,thk_anom -v topg,topg_anom anom_topography_file.nc
ncks -A -v thk_anom,topg_anom anom_topography_file.nc ref_topography_file.nc
ncap2 -O -s "thk=thk+thk_anom;topg=topg+topg_anom" -v ref_topography_file.nc input_topography_file.nc

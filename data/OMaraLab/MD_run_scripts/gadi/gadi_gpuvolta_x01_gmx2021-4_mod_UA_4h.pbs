...
GMX='gmx'
GMXMDRUN='gmx mdrun -maxh 3.95 -nb gpu -pin -ntmpi 1 -ntomp 12'  # when I run without explicitly setting -ntmpi and -ntomp performance goes through the floor. ¯\_(ツ)_/¯

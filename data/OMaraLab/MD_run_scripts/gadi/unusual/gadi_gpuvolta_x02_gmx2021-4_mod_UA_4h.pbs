...
## This script uses 2 GPUS and 24 CPUS, which is typically NOT OPTIMAL for a united atom system

## IMPORTANT:  MAKE SURE YOU BENCHMARK.  MY PERFORMANCE WITH THIS SCRIPT HAS BEEN VERY SPOTTY RECENTLY
...
GMX='gmx'
GMXMDRUN='gmx mdrun -maxh 3.95 -nb gpu -pin -ntmpi 2 -ntomp 12'

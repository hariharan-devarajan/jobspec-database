...
export build_name=RDR-CentOS-6.6-gcc4.4.6-debug
...
python setup.py --fc=gfortran --cc=gcc --cxx=g++ --type=debug --python=$PYTHON --cmake-options='-DBUILDNAME=${build_name} -DSITE=${site_name} -DFORCE_CUSTOM_BOOST=ON'

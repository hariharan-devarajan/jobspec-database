...
#SBATCH -o logs/minestral-350m-en-04012024/extract_data_from_hf-job.out              # Name of stdout output file
#SBATCH -e logs/minestral-350m-en-04012024/extract_data_from_hf-job.err              # Name of stderr error file
...
#     --max_samples 6_000_000 --streaming --split_size 500_000

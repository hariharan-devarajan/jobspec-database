...
cd "$WORK"/deepfigures-results/arxiv_data_temp || exit
find -type d -print0 | xargs -i -n1 -0 -P"$NUM_CPUS" zip -r {}.zip {}
mv ..zip "$WORK"/deepfigures-results/arxiv_data_temp_"$i"_"$ts".zip

cd "$WORK"/deepfigures-results/arxiv_data_output || exit
find -type d -print0 | xargs -i -n1 -0 -P"$NUM_CPUS" zip -r {}.zip {}
mv ..zip "$WORK"/deepfigures-results/arxiv_data_temp_"$i"_"$ts".zip

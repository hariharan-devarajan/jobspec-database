...
#rsync -ahr -P /lfs/h2/emc/vpppg/noscrub/steven.simon/metplusworkspace/EVS ddxfer.wcoss2.ncep.noaa.gov:/lfs/h2/emc/vpppg/noscrub/shelley.melchior/forSSi/EVS/.

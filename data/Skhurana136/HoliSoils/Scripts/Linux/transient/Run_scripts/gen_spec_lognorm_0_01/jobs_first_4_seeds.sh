...
python "/home/x_swakh/tools/HoliSoils/Scripts/Linux/transient/Run_scripts/gen_spec_lognorm_0_01/carbon_switch_off_competition_adaptation.py" --sim_label "competition_adaptation" --seeds_num 610229235 983307757 643338060 714504443
# Scripts ends here
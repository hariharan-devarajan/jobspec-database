...
python "/home/x_swakh/tools/HoliSoils/Scripts/Linux/transient/Simulation_processing/calculate_respiration.py" "gen_spec_lognorm_0_1"
# Scripts ends here
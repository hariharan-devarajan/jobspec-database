...
#SBATCH --cpus-per-task=5 # number of CPUs for this task //added by wyn
...
# aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:064666353788:awsnotify --message "RS4aJobDone"

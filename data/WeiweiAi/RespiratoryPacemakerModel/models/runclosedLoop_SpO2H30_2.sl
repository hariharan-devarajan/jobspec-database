#!/bin/bash -e
#SBATCH --job-name=closedLoop_SpO2H30_2            # job name (shows up in the queue)
#SBATCH --account=uoa00596     # Project Account
#SBATCH --time=168:00:00         # Walltime (HH:MM:SS)
#SBATCH --mem=6000      # memory/cpu (in MB)
...
matlab -nojvm -nodisplay -r "run('${script_path}runClosedLoopSo2_30_2.m');exit;"
rm -r ${working_path}

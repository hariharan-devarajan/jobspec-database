...
if args.previous_job_id:
    ...
    best_model_name_pattern = f'{root_dir}models/*{resume_training_previous_job_id}*'
    ...
    if len(best_models) == 0:
        ...
        best_model_name_pattern = f'{cur_dir}models/*{resume_training_previous_job_id}*'
        best_models = glob.glob(best_model_name_pattern)
...
if model_type == 'cnn':
    ...
    list_of_dicts = json.load(open(f'/hercules/scratch/atya/BinaryML/hyperparameter_tuning/cnn/list_of_dicts.json','r'))
    ...
    list_of_dicts = json.load(open(f'/hercules/scratch/atya/BinaryML/hyperparameter_tuning/attention_z/list_of_dicts.json','r'))
...
epochs = 20000
patience = 200
best_model_name = f'{cur_dir}models/predict_{predict_index}_{run}_{model_type}_{job_id}_'

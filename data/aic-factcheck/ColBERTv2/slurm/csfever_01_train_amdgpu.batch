...
#SBATCH --out=../logs/csfever_01_colbert_train.%j.out
...
# CFG=cfg/train/csfever/train_nway128.config.py
# CFG=cfg/train/csfever/train_nway_l2.config.py
# CFG=cfg/train/wiki_cs/train_nway_fever_size.config.py
# CFG=cfg/train/csfever/train_nway_ev.config.py
# CFG=cfg/train/csfever/train_normal+fake_f3_nway_ev.config.py

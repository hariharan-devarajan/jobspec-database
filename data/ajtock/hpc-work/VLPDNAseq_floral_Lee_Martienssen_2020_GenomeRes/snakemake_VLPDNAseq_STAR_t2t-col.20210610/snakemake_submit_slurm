...
#! Name of the job:
#SBATCH -J VLPDNAseq_floral_t2t-col.20210610
...
#SBATCH --output=logs/snakemake_submit_JobName.%J.out
#! Per-array-task-ID error file (NOTE: enclosing directory must exist)
#SBATCH --error=logs/snakemake_submit_JobName.%J.err
#! For 6GB per CPU, set "-p skylake"; for 12GB per CPU, set "-p skylake-himem": 
#SBATCH -p skylake
#! Number of CPUs per task. Default: 1
#!SBATCH --cpus-per-task=32
#! Minimum RAM needed per node
#SBATCH --mem=180G

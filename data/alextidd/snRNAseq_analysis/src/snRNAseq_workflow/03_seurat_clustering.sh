#!/bin/bash
#PBS -N seurat_clustering
#PBS -o /rds/general/user/art4017/home/snRNAseq_analysis/log/seurat_clustering.out
#PBS -e /rds/general/user/art4017/home/snRNAseq_analysis/log/seurat_clustering.err

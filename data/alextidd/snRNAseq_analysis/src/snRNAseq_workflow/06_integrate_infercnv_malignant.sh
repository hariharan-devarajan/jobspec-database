#!/bin/bash
#PBS -N malignant
#PBS -o /rds/general/user/art4017/home/snRNAseq_analysis/log/malignant.out
#PBS -e /rds/general/user/art4017/home/snRNAseq_analysis/log/malignant.err
...
nextflow run ../snRNAseq_workflow/06_integrate_infercnv_malignant.nf \

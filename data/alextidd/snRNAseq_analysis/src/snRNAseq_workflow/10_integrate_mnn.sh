#!/bin/bash
#PBS -N integrate_mnn
#PBS -o /rds/general/user/art4017/home/snRNAseq_analysis/log/integrate_mnn.out
#PBS -e /rds/general/user/art4017/home/snRNAseq_analysis/log/integrate_mnn.err
...
nextflow run ../snRNAseq_workflow/10_integrate_mnn.nf \

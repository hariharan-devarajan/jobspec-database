#!/bin/bash
#PBS -N integrate_all
#PBS -o /rds/general/user/art4017/home/snRNAseq_analysis/log/integrate_all.out
#PBS -e /rds/general/user/art4017/home/snRNAseq_analysis/log/integrate_all.err
...
nextflow run ../snRNAseq_workflow/02_integrate.nf \
  ...
  --input.run_by_patient_wo_organoids false \
  --input.run_by_patient false \
  --input.run_by_sample false \
  --input.run_all false \
  --input.run_all_wo_organoids true \

...
#SBATCH --output=/common/home/projectgrps/CS704/CS704G1/MetaOptNet/sbatch_logs/miniImageNet_MetaOptNet_RR/%u.%j.out  
...
#SBATCH --job-name=metalearning_miniImageNet_MetaOptNet_RR          
...
# Execute script with sbatch optim_job_mininet.sh

...
store_path="${workingdir}/data/${subject}"
...
tmp_path="${workingdir}/tmp/${subject}/${streamlines}"
out_path="${workingdir}/data/${subject}/T1w/tractography"
...
5ttgen fsl "${tmp_path}/T1.mif" "${tmp_path}/5tt.mif" -premasked -nthreads 16
...
# done
# done < subjectlists/subject_list_HCP_20.txt
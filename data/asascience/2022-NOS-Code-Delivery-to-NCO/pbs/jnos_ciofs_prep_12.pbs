...
#PBS  -A NOSOFS-DEV
#PBS  -q dev
#PBS  -o /lfs/h1/nos/ptmp/aijun.zhang/rpt/v3.5.0/ciofs_prep_12.out
#PBS  -e /lfs/h1/nos/ptmp/aijun.zhang/rpt/v3.5.0/ciofs_prep_12.err
...
WORKDIR=/lfs/h1/nos/ptmp/$LOGNAME/work/${nosofs_ver}/ciofs
if [ ! -r $WORKDIR ]; then
...
#s=${PBS_JOBID}
#mv ${RPTDIR}/ciofs_prep_12.out ${RPTDIR}/ciofs_prep_12.out."${s%%.*}"
#mv ${RPTDIR}/ciofs_prep_12.err ${RPTDIR}/ciofs_prep_12.err."${s%%.*}"

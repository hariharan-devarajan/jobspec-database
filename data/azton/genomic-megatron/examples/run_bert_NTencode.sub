...
LOG="BERTNTE_SP${SPSIZE}_MP${MPSIZE}_PP${PPSIZE}_NL${NLAYERS}_H${HIDDEN}_A${ATEN_HEADS}_L${SEQ_LEN}_ZERO${ZERO_STAGE}_FLASH${USE_FLASH_ATTN}_NN${NTOTRANKS}"

TENSORBOARD_DIR=./runlogs/tensorboard
WANDB_GROUP='3.3Bm-scalerun'
WANDB_RESUME=0
...
# ┗━━━━━━━━━━━━┛
DATA_PATH=
DATA_DIR="/lus/eagle/projects/RL-fold/azton/genomes/NTT/megatron-bins/nt_encoded"
# DATA_PATH="${DATA_DIR}/codon_3mer_0_text_d"
for i in $(seq 0 10); do
    for subfile in $(seq 0 3); do
        DATA_PATH="0.0125 ${DATA_DIR}/ncbi_fixed_nt_splitds_${i}_${subfile}_text_document"
    done
done
# DATA_PATH="1.0 /lus/eagle/projects/RL-fold/azton/genomes/NTT/megatron-bins/fixed_6mer_full_text_document"
VOCAB_FILE=/lus/eagle/projects/candle_aesp/azton/GenomeLM/genomelm/tokenizer_files/genslm_nt_tokenizer.json
...
DS_CONFIG=./ds_config_zero1_bf16.json
ds_args=""

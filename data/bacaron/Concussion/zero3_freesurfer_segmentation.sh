...
export SUBJECTS_DIR=/N/dc2/projects/lifebid/Concussion/concussion_real/freesurfer/${SUBJ}
source $FREESURFER_HOME/SetUpFreeSurfer.sh

cd /N/dc2/projects/lifebid/Concussion/concussion_real/freesurfer/${SUBJ}

recon-all -s pilot_hq -i t1_acpc.nii.gz -all -openmp 16

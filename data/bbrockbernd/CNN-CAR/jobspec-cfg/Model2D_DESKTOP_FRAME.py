...
class HyperModel2D(kt.HyperModel):
    ...
    def fit(self, hp, model, *args, **kwargs):
        framelength = hp.Int('frame length', 256, 4096, 64)
        ...
        trainX, trainy, testX, testy = loader.load_1D_framesplit(framelength=framelength, validation=0.2)
...
def optimize():
    tuner = CustomOptimizer(HyperModel2D(),
                            ...
                            max_trials=200,
                            overwrite=False,
                            directory="/scratch/bbrockbernd/tuning_2D_desktop_frame",

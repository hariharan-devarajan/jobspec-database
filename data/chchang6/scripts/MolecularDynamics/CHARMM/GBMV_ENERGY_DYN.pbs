...
cat > stream.inp << EOF
* Energy calculation last 2000 snapshots of NAMD production dynamics
...
export input="stream=GBMV_ENERGY_DYN.INP"

which charmm.mpi.xxlarge
mpicmd charmm.mpi.xxlarge $input < stream.inp > GBMVdyn.out

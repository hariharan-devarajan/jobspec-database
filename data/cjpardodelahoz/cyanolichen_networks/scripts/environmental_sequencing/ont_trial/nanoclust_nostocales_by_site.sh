...
# Sample variable
sample=$(cat misc_files/environmental_sequencing/trial_sites.txt| sed -n ${SLURM_ARRAY_TASK_ID}p)
# Path to output
nanoclust_out="analyses/environmental_sequencing/ont_trial/nanoclust/nostocales/site_pools"
# Path to reads

...
# usage:
# while read rna_id visit rna_gds output_dir; do echo $rna_id; sbatch scripts/all_by_all_compare_chr6.sh $rna_id $visit $rna_gds $output_dir; done < samplesheets/all_by_all_121_160.txt

#!/bin/bash
#SBATCH -e ./txt/error%j.txt
#SBATCH -o ./txt/output%j.txt
#SBATCH -J flex
#SBATCH -n 1
#SBATCH -t 1:00:00
#SBATCH -p serial
...
py_script='/homeappl/home/aliagadi/saltena_2018/flexpart_management/flexpart_management/notebooks/log_pol_revisited/log_pol_revisited_taito.py'

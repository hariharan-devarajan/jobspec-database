...
conda create -p dhenv_basic --clone base -y
conda activate dhenv_basic/
...
pip install -e "deephyper/[default,mpi]"
...
echo "conda activate $PWD/dhenv_basic/" >> activate-dhenv.sh

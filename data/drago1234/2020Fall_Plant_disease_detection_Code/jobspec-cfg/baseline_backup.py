...
validation_generator = train_datagen.flow_from_directory(
    DATA_PATH,
    target_size=(img_width, img_height),  # (256, 256, 3) (224, 224, 3)
    color_mode='rgb', #  "grayscale", "rgb", "rgba", Default: "rgb". Whether the images will be converted to have 1, 3, or 4 channels.
    class_mode = 'categorical', # One of "categorical", "binary", "sparse", "input", or None.
#     label_mode='int', # 'int': encoded as integer for sparse_categorical_crossentropy loss, 'categorical': encoded as categorical vector for categorical_crossentropy loss, 'binary': encoded as 0 or 1 for binary_crossentropy
    batch_size=batch_size,
...
print(f"val_size: {validation_generator.n}, train_size: {train_generator.n}")
...
MODEL_NAME = 'InceptionV3_model' # VGG19, ResNet, NASNet, InceptionV3, NASNetLarge, NASNetMobile, MobileNet-v3-small, MobileNetV3Large_model
...
# ResNet50_custom_layer = ResNet50_model.get_layer('conv5_block2_out')
...
model.compile(optimizer=optimizer,
              ...
              metrics=METRICS)
print(f"\n====> Statistics: Model name: {MODEL_NAME}, epochs={no_epochs}, batch_size={batch_size}, validation_split={validation_split}, lr={lr}, momentum={momentum}, steps_per_epoch ={steps_per_epoch}, feature shape= {(img_width, img_height, img_num_channels)}, no_classes={no_classes }, loss_function={loss_function}")
print(model.summary())

...
#PBS -o ./log/parallel/cooking/4rounds-vanilla/5e-5-40-0.001/4rounds-mp.output
#PBS -e ./log/parallel/cooking/4rounds-vanilla/5e-5-40-0.001/4rounds-mp.err
...
fake=`time python3 main.py --start_q $start_q --num_q $num_q --epochs 4 --sample_nums 40 --wd 0.001 --ilr 5e-5 --topic cooking --n_iter_rounds 4 --batch_size 1 --save_dir /work/zu20361/BDL/model/ --model_name vanilla_bert_3epoch_5e-5-16-0.01 --interactive True --test_mode valid_interaction`
echo "$fake" > ./log/parallel/cooking/4rounds-vanilla/5e-5-40-0.001/start-${start_q}.output

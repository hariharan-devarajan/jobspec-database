#!/bin/bash
#PBS -N bdl-travel-unc
#PBS -o ./log/parallel/travel/unc-hyper/1e-4-0.001/4rounds-5epochs-mp.output
#PBS -e ./log/parallel/travel/unc-hyper/1e-4-0.001/4rounds-5epochs-mp.err
...
fake=`time python3 main.py --start_q $start_q --num_q $num_q --epochs 4 --sample_nums 20 --wd 0.001 --ilr 1e-4 --querier_type unc --topic travel --n_iter_rounds 4 --batch_size 1 --save_dir /work/zu20361/BDL/model/ --model_name vanilla_bert_3epoch_2e-5-16-0.01 --interactive True --test_mode valid_interaction `
echo "$fake" > ./log/parallel/travel/unc-hyper/1e-4-0.001/start-${start_q}.output

...
#BSUB -R "select[hname=='gpu-cn015']" # gpu-cn001 always give me cuda OOM error
#BSUB -M 10000			# amount of memory in MB per process
#BSUB -J bert_pretraining			# job name
...
cd ../PyTorch
mpirun -n 1 python train.py --config_file="bert-base-single-node-rui.json" --config_file_path="/gpfs/gpfs0/groups/mozafari/ruixliu/code/AzureML-BERT/pretrain/configs" --train_path="/gpfs/gpfs0/groups/mozafari/ruixliu/data/enwiki/bin_shards" --validation_path="/gpfs/gpfs0/groups/mozafari/ruixliu/data/enwiki/validation" --output_dir="/gpfs/gpfs0/groups/mozafari/ruixliu/tmp/models" --use_multigpu_with_single_device_per_process=False --train_batch_size=32 --log_steps=40 --accumulate_gradients=False

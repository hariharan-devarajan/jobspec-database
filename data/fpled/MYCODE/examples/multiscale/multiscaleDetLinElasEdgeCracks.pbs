...
#PBS -o multiscaleDetLinElasEdgeCracks.out

# File name for standard error
#PBS -e multiscaleDetLinElasEdgeCracks.err
...
#PBS -V
JOBID=${PBS_JOBID%%.*}
MATLAB_FILENAME=multiscaleDetLinElasEdgeCracks

...
#SBATCH -o /scratch/project_2002820/lihsin/finbert-text-classification/output/%j.out
#SBATCH -e /scratch/project_2002820/lihsin/finbert-text-classification/output/%j.err

...
#    -pco2atm_ini 300.0 \
#    -dc13atm_ini -15.5 \
#    -atm_write_time_steps 5 \
#    > log

# Options for sediment model
#   -num_ocean_steps_per_sed_step 1095 \
#   -sed_write_time_steps 1095 -osed_mixed sedmixed.petsc -osed_buried sedburied.petsc

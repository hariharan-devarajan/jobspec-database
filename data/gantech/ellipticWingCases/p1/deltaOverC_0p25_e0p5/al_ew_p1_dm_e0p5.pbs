...
#PBS -l nodes=2:ppn=24                # Number of nodes, put 24 processes on each
#PBS -N ew_p1_dm_e0p5                 # Name of job
...
mpirun -np 48 /home/gvijayak/CurrentProjects/Nalu/build.actLineHO/naluX -i ellipticWing.i --pprint &> log.run

...
#SBATCH --gres=gpu:1
#SBATCH --mem=60G
#SBATCH --output=/home/gebreawe/Model_logs/Segmentation/T-UDA/logs/train_usl_f2_2_time_%j.log     # file name for stdout/stderr
# module
...
#CUDA_VISIBLE_DEVICES=0,1 NCCL_P2P_DISABLE=1 python -u -m torch.distributed.launch --nproc_per_node=2 --master_port=$RANDOM train_uda.py --config_path 'configs/data_config/da_kitti_usl/uda_usl_kitti_f2_0_time.yaml' 2>&1 | tee logs_dir/${name}_logs_uda_usl_kitti_f2_2_time.txt

...
#SBATCH --gres=gpu:1
#SBATCH --mem=60G
#SBATCH --output=/home/gebreawe/Model_logs/Segmentation/T-UDA/logs/train_uda_wod_nuscenes_f2_0_time_%j.log     # file name for stdout/stderr
# module
...
python train_uda.py --config_path 'configs/data_config/da_wod_nuscenes/uda_wod_nuscenes_f2_0_time.yaml' 2>&1 | tee logs_dir/${name}_uda_wod_nuscenes_f2_0_time.txt

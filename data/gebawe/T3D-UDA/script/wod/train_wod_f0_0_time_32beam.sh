...
#SBATCH --gres=gpu:1
#SBATCH --mem=60G
#SBATCH --output=/home/gebreawe/Model_logs/Segmentation/ST-UDA/logs/wod_train_f0_0_all_v3_2_time_beam32_%j.log     # file name for stdout/stderr
# module
...
python train_wod.py --config_path 'configs/wod/wod_f0_0_time_beam32.yaml' 2>&1 | tee logs_dir/${name}_logs_wod_f0_0_b2_v3_2_time_beam32.txt

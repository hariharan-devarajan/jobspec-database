...
n_processes = 16 #16 # number of pool processes to run for stellar SED generation
n_MPI_processes = 16 #10 # number of MPI tasks to run. for TORQUE this is  #usually 1
...
#===============================================
add_neb_emission = False #set to True to add nebular lines    			    # add nebular line emission (under active development)

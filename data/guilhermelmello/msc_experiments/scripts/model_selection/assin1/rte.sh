#PBS -N assin1_rte_model_selection
#PBS -q umagpu
#PBS -e outputs/model_selection_assin1_rte.err
#PBS -o outputs/model_selection_assin1_rte.out
#PBS -m ae
...
nvidia-smi pmon >> outputs/usogpu_assin1_rte &

# run python script
echo "Running python script"
python -m scripts.model_selection_assin1_rte

#PBS -N assin1_sts_model_selection
#PBS -q umagpu
#PBS -e outputs/model_selection_assin1_sts.err
#PBS -o outputs/model_selection_assin1_sts.out
#PBS -m ae
...
nvidia-smi pmon >> outputs/usogpu_assin1_sts &

# run python script
echo "Running python script"
python -m scripts.model_selection.assin1.sts

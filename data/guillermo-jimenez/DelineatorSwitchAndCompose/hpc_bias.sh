...
#SBATCH -o /homedtic/gjimenez/DADES/DADES/DelineationResults/BIAS_20_SEPARATE/LOGS/%A_%a.out
#SBATCH -e /homedtic/gjimenez/DADES/DADES/DelineationResults/BIAS_20_SEPARATE/LOGS/%A_%a.err

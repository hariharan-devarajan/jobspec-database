...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[1, 10, 100, 500, 3000,7000,14000, 20000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[1, 10, 100, 500, 3000, 7000, 14000, 20000])

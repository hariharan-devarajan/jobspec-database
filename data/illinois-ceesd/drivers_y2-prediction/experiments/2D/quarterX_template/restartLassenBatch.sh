...
$jsrun_cmd bash -c 'POCL_CACHE_DIR=$POCL_CACHE_DIR_ROOT/$$ python -O -u -m mpi4py ./prediction.py -i run_params.yaml -r ${dumpFile} -t restart_data/prediction-000000 --lazy --log > ${outputFile}'

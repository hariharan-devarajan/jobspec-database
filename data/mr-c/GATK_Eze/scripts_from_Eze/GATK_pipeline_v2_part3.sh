...
#BSUB -o trash/output.%J.chr%I
#BSUB -e trash/errors.%J.chr%I
...
if [ ! -f $root_folder/logs/part_3_GenotypeGVCFs_finished_chr$chr.txt ]; then
	...
	# NOTE:
	# changed --dbsnp $bundle2_8/b37/dbsnp_138.b37.vcf
	# for --dbsnp /scratch/DGE/OGENETIC/eanokian/ICGC/annotation/All_20170710.vcf.gz

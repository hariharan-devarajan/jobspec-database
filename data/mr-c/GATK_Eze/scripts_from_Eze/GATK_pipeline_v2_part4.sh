...
if [ ! -f $root_folder/logs/part_4_GATK_indel_VQSR_finished.txt ]; then
	...
	# note:
	# added -an DP
	# removed -an InbreedingCoeff, add it when we have 10 or more samples
...
if [ ! -f $root_folder/logs/part_4_GATK_CalculateGenotypePosteriors_finished.txt ]; then
	...
	# NOTE:
	# change --supporting $bundle2_8/b37/1000G_phase3_v4_20130502.sites.vcf.gz
	# for --supporting /scratch/DGE/OGENETIC/eanokian/ICGC/annotation/ALL.wgs.phase3_shapeit2_mvncall_integrated_v5b.20130502.sites.vcf.gz

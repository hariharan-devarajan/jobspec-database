...
#SBATCH -D /gpfs/scratch/bsc88/bsc88080/crosslingual_vaccines/
...
DATASET_PATH="/gpfs/scratch/bsc88/bsc88080/crosslingual_vaccines/data/$SPLIT_STRATEGY/DynamicStance.py"
echo $DATASET_PATH
LEARN_RATE=0.00001

...
#OAR -n CGvsNI-testArtlantisAutodesk-fullsup
#OAR -t gpu
#OAR -l /nodes=1/gpudevice=1,walltime=16:00:00
#OAR --stdout scripts_logs/CGvsNI-testArtlantisAutodesk-fullsup.out
#OAR --stderr scripts_logs/CGvsNI-testArtlantisAutodesk-fullsup.err
#OAR --project cg4n6

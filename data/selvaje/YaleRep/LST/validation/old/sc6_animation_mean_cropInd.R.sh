...
png(paste(path,basename,"_India.png",sep=""),width=1000,height=1000)
## add width and height to specify the size of the png, otherwise it will be small (100x100, I think)

day001=((raster(paste(path,basename,".tif", sep="") , xmn=65 ,  ymx=35 ,  xmx=100 , ymn=5   ) * 0.02) - 272.15 )
...
greg=list(ylim=c(5,35),xlim=c(65,100))

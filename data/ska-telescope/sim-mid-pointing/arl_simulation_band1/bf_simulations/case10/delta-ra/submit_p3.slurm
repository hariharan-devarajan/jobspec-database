...
for host in `cat hostfile.$JOBID`; do
    ...
    if [ "$hostIndex" = "0" ]; then
        ...
        ssh $host --interface ib0 dask-scheduler --port=8786 &
        sleep 5
    fi
...
CMD="python  ../../../../pointing_simulation_distributed.py --context null --frequency 0.765e9 --rmax 1e5 \
--flux_limit 0.003 \
 --show True --offset_dir 1.0 0.0 \
--seed 18051955  --pbtype MID_FEKO_B1 --memory 32 --integration_time 30 --use_agg True --time_series wind --time_chunk \

...
CMD="python  ../../../../pointing_simulation_distributed.py --context s3sky --frequency 1.36e9 --rmax 1e5 --flux_limit 0.003 \
 --show True \
--seed 18051955  --pbtype MID_FEKO_B2 --memory 32  --integration_time 30 --use_agg True \
--time_range -5 5 --time_series wind --time_chunk \
1800 --shared_directory ../../../../shared --declination 0 | tee pointing_simulation.log"

...
CMD="python  ../../../../pointing_simulation_distributed.py --context null --frequency 12.179e9 --rmax 1e5 --flux_limit
0.003 \
 --show True --offset_dir 1.0 0.0 \
--seed 18051955  --pbtype MID_FEKO_Ku --memory 32 --integration_time 30 --use_agg True --time_series wind --time_chunk \

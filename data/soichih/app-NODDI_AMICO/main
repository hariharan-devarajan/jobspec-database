...
noddiImages="FIT_ICVF_NEW FIT_ISOVF_NEW FIT_OD_NEW FIT_dir config.pickle";
noddiFile="NODDI";
mkdir $noddiFile;
...
for NODDIIMAGE in "FIT_dir config.pickle"
	do
		mv ./$noddiFile/AMICO/NODDI/${NODDIIMAGE} ./
	done
